...
class UsuariosController extends AppController
{
    ...
    public function add($id = null)
    {
        if ($this->isAdmin()) {
            ...
            if ($this->request->is('post')) { // Incluir novo usuario ou salvar edição
                $nomeUsuario = $this->Usuario->findByUsername($this->request->data['username']);
                if (!empty($nomeUsuario) && empty($this->request->data['id'])) {
